...
```javascript
import truncsd from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-special-truncsd@v0.3.1-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/math-base-special-truncsd/actions/workflows/test.yml/badge.svg?branch=v0.3.1
[test-url]: https://github.com/stdlib-js/math-base-special-truncsd/actions/workflows/test.yml?query=branch:v0.3.1
